...
// Only include TwinStick headers here if the header truly needs their full types:
#include "Variant_TwinStick/TwinStickCharacter.h"
// For AI types, prefer forward declarations in headers and include in .cpp instead.
