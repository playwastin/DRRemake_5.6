...
protected:
	...
	UPROPERTY(EditAnywhere, Category="Pickup", meta=(ClampMin = 0, ClampMax = 5, Units = "Seconds"))
...
public:
	...
	/** If true, this NPC has already been hit by a projectile and is being destroyed */
