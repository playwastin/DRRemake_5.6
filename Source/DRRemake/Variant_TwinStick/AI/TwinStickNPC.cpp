...
// --- includes (replace your current includes with this block) ---
#include "Variant_TwinStick/AI/TwinStickNPC.h"     // MUST be first: its own header

// (keep any other engine/framework includes you already had below)
