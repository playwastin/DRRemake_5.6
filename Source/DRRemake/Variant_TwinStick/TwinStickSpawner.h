...
// If you need the NPC type in this header, include it with the module path:
#include "Variant_TwinStick/AI/TwinStickNPC.h"

// (keep other needed includes; prefer forward declarations in headers when possible)
